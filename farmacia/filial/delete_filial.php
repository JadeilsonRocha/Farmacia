...
<body>
	<h1><center>Remover Filial</center></h1>
<div class="manageMember">
	...
	<table border="2" cellspacing="3" cellpadding="5">
		...
		<tbody>
			<?php
			$sql = "SELECT * FROM filial as f, endereco as e WHERE f.codEndereco = e.codEndereco";
			...
			if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>".$row['fone']."</td>
						<td>
							<a href='remove_filial.php?codFilial=".$row['codFilial']."'><button type='button'>Excluir</button></a>
						</td>
					</tr>";
				}
			} else {
