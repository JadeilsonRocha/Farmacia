...
<div class="manageMember">
	...
	<table border="2" cellspacing="3" cellpadding="5">
		...
		<tbody>
			<?php
			$sql = "SELECT * FROM filial as f, endereco WHERE f.codEndereco = endereco.codEndereco";
			...
			if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>".$row['fone']."</td>
						<td>
							<a href='edit_filial.php?codFilial=".$row['codFilial']."'><button type='button'>Editar</button></a>
						</td>
					</tr>";
				}
			} else {
