...
<body>
	<h1><center>Deletar Medicamento</center></h1>
			...
			if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>
							<center> <a href='remove_medicamento.php?codProduto=".$row['codProduto']."'><button type='button'>Remover Dados</button></a> </center>
						</td>
					</tr>";
				}
			} else {
