...
<div class="manageMember">
	...
	<table border="2" cellspacing="3" cellpadding="5">
		...
		<tbody>
			<?php
			$sql = "SELECT * FROM laboratorio as l, endereco WHERE l.codEndereco = endereco.codEndereco";
			...
			if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>".$row['fone']."</td>
						<td>
							<a href='edit_lab.php?cnpj=".$row['cnpj']."'><button type='button'>Editar Dados</button></a>
						</td>
					</tr>";
				}
			} else {
