...
<body>
	<h1> <center> Lista de Relações Comerciais </center> </h1>
<div class="manageMember">
	...
	<table border="2" cellspacing="3" cellpadding="5">
		...
		<tbody>
			<?php # SELECT * FROM comercializacao AS c JOIN produto ON c.idProduto = produto.codProduto;
			$sql = "SELECT * FROM comercializacao as c Join produto on c.idProduto = produto.codProduto "; # WHERE comercializacao.idEndereco = endereco.codEndereco
