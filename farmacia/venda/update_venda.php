...
<body>
	<h1> <center>Atualizar Vendas</center> </h1>
	...
	<table border="2" cellspacing="3" cellpadding="5">
		<thead>
			<tr>
				<th>Codigo</th>
				<th>CPF</th>
				<th>Data da Venda (YYYY-MM-DD)</th>
				<th>Valor Total</th>
		...
		<tbody>
			<?php
			$sql = "SELECT * FROM venda where codVenda >=1";
			...
			if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>".$row['formaPag']."</td>
						<td>
							<a href='edit_venda.php?codVenda=".$row['codVenda']."'><button type='button'>Editar</button></a>
						</td>
					</tr>";
				}
			} else {
				echo "<tr><td colspan='5'><center>Não há vendas atualmente.</center></td></tr>";
			}
			?>
...
</html><?php require_once '../php_action/db_connect.php'; ?>
